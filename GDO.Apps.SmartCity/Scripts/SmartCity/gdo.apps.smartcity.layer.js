gdo.net.app["SmartCity"].LAYER_TYPES_ENUM = {
    Base: 0,
    Heatmap: 1,
    Image: 2,
    Tile: 3,
...
gdo.net.app["SmartCity"].addLayer = function (instanceId, layerId, deserializedLayer) {
    gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Adding Layer: ' + deserializedLayer.Id);
    if (gdo.net.instance[instanceId].sources[deserializedLayer.Source.Id] == null || typeof gdo.net.instance[instanceId].sources[deserializedLayer.Source.Id] == "undefined") {
        gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Adding Source: ' + deserializedLayer.Source.Id);
        gdo.net.app["SmartCity"].addSource(instanceId, deserializedLayer.Source.Id, deserializedLayer.Source);
    }
    var layer;
    var properties;
    var options = {};
    switch (deserializedLayer.Type) {
        case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Heatmap:
            properties = [
            ...
            break;
        case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Image:
            properties = [
                ["brightness",deserializedLayer.Brightness],
                ["contrast",deserializedLayer.Contrast],
                ["hue",deserializedLayer.Hue],
            ...
            break;
        case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Tile:
            properties = [
                ["brightness",deserializedLayer.Brightness],
                ["contrast",deserializedLayer.Contrast],
                ["hue",deserializedLayer.Hue],
            ...
            break;
        case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Vector:
            if (gdo.net.instance[instanceId].styles[deserializedLayer.Style.Id] == null || typeof gdo.net.instance[instanceId].styles[deserializedLayer.Style.Id] == "undefined") {
                gdo.net.app["SmartCity"].addStyle(instanceId, deserializedLayer.Style.Id, deserializedLayer.Style);
                gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Added Style: ' + deserializedLayer.Style.Id);
            }
            properties = [
                ["brightness",deserializedLayer.Brightness],
                ["contrast",deserializedLayer.Contrast],
            ...
            break;
        default:
            gdo.consoleOut('.SmartCity', 5, 'Instance ' + instanceId + ': Invalid Layer Type: ' + deserializedLayer.Type + ' for Layer '  + deserializedLayer.Id);
            break;
    }
...
gdo.net.app["SmartCity"].updateLayer = function (instanceId, layerId, deserializedLayer) {
    gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Updating Layer: ' + deserializedLayer.Id);
...
gdo.net.app["SmartCity"].updateZIndexTable = function (instanceId, deserializedZIndexTable) {
    gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Updating ZIndexes: ' + layerId);
    //TODO for each layer set z index
}

gdo.net.app["SmartCity"].requestLayer = function (instanceId, layerId) {
    gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Requesting Layer: ' + layerId);
    gdo.net.app["SmartCity"].server.requestLayer(instanceId, layerId);
}

gdo.net.app["SmartCity"].uploadLayer = function (instanceId, layerId, isNew) {
    gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Uploading Layer: ' + layerId);
    var layer = gdo.net.instance[instanceId].layers[layerId];
    ...
    if (isNew) {
        switch (type) {
            case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Heatmap:
                gdo.net.app["SmartCity"].server.addHeatmapLayer(instanceId, properties.Name, properties.Type, properties.Brightness, properties.Contrast,
                ...
                break;
            case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Image:
                gdo.net.app["SmartCity"].server.addImageLayer(instanceId, properties.Name, properties.SourceId, properties.Brightness, properties.Contrast,
                    properties.Saturation, properties.Hue, properties.Opacity, properties.Visible, properties.MinResolution,
                    properties.MaxResolution);
                break;
            case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Tile:
                gdo.net.app["SmartCity"].server.addTileLayer(instanceId, properties.Name, properties.SourceId, properties.Brightness, properties.Contrast,
                    properties.Saturation, properties.Hue, properties.Opacity, properties.Visible, properties.MinResolution,
                    properties.MaxResolution, properties.Preload);
                break;
            case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Vector:
                gdo.net.app["SmartCity"].server.addVectorLayer(instanceId, properties.Name, properties.SourceId, properties.Brightness, properties.Contrast,
                    properties.Saturation, properties.Hue, properties.Opacity, properties.Visible, properties.MinResolution,
                ...
                break;
            default:
                gdo.consoleOut('.SmartCity', 5, 'Instance ' + instanceId + ': Invalid Layer Type: ' + type + ' for Layer ' + layerId);
                break;
        }
    } else {
        switch (type) {
            case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Heatmap:
                gdo.net.app["SmartCity"].server.updateHeatmapLayer(instanceId, layerId, properties.Name, properties.Type, properties.Brightness, properties.Contrast,
                    properties.Saturation, properties.Hue, properties.Opacity, properties.Visible, properties.MinResolution,
                    properties.MaxResolution, properties.Gradient, properties.Radius, properties.Blur);
                break;
            case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Image:
                gdo.net.app["SmartCity"].server.updateImageLayer(instanceId, layerId, properties.Name, properties.SourceId, properties.Brightness, properties.Contrast,
                    properties.Saturation, properties.Hue, properties.Opacity, properties.Visible, properties.MinResolution,
                    properties.MaxResolution);
                break;
            case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Tile:
                gdo.net.app["SmartCity"].server.updateTileLayer(instanceId, layerId, properties.Name, properties.SourceId, properties.Brightness, properties.Contrast,
                    properties.Saturation, properties.Hue, properties.Opacity, properties.Visible, properties.MinResolution,
                    properties.MaxResolution, properties.Preload);
                break;
            case gdo.net.app["SmartCity"].LAYER_TYPES_ENUM.Vector:
                gdo.net.app["SmartCity"].server.updateVectorLayer(instanceId, layerId, properties.Name, properties.SourceId, properties.Brightness, properties.Contrast,
                    properties.Saturation, properties.Hue, properties.Opacity, properties.Visible, properties.MinResolution,
...
gdo.net.app["SmartCity"].removeLayer = function (instanceId, layerId) {
    gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Removing Layer: ' + layerId);
...
gdo.net.app["SmartCity"].setLayerVisible = function (instanceId, layerId, visible) {
    gdo.consoleOut('.SmartCity', 1, 'Instance ' + instanceId + ': Setting Layer Visible: ' + layerId + ': ' + visible);
    gdo.net.instance[instanceId].layers[layerId].setVisible(visible);
}

gdo.net.app["SmartCity"].isLayerVisible = function (instanceId, layerId) {
    return gdo.net.instance[instanceId].layers[layerId].getVisible();
}

gdo.net.app["SmartCity"].animateLayer = function (instanceId, layerId) {
    //TODO
}