...
namespace GDO.Apps.Hercules.BackEnd
{
    ...
    public class Augmenter
    {
        ...
        {
            return FromPlain(Parser.FromFile(path, delimiter));
        }
        ...
        {
            return FromPlain(Parser.FromStream(stream, delimiter));
        }
        ...
        {
            throw new Exception("Augmenter.FromURL: not implemented yet!");
        }
        ...
        {
            if (ds == null) {
                throw new Exception("Augmenter.FromPlain: PlainDS can't be null!");
            }
