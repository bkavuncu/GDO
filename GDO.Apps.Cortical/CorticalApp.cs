...
namespace GDO.Apps.Cortical
{
    ...
    public class CorticalApp : IBaseAppInstance {
        ...
        public string ProcessGraph(string filename, bool zoomed, string folderName)
        {
            ...
            CorticalAppHub.self.LogTime("Time taken to distribute nodes across browsers: " + sw.ElapsedMilliseconds + "ms");
            ...
            CorticalAppHub.self.LogTime("Time taken to distribute links across browsers: " + sw.ElapsedMilliseconds + "ms");

            // write to individual browser file
            // i. create sub-directories to store partition files
            Debug.WriteLine("Writing partition files");
            CorticalAppHub.self.LogTime("Writing partition files");
        ...
        /*private static void WriteNodeFiles(int totalRows, int totalCols, string linksPath, Partition[,] partitions)
        {
            ...
            CorticalAppHub.self.LogTime("Time taken to write nodes file: " + sw.ElapsedMilliseconds + "ms");
        }
        */
        /*private static void WriteLinkFiles(int totalRows, int totalCols, string linksPath, Partition[,] partitions)
        {
            ...
            CorticalAppHub.self.LogTime("Time taken to write links file: " + sw.ElapsedMilliseconds + "ms");
        }
        */
        /*
        ...
        /*private void SetupNodesDictionary()
        {
            ...
            foreach (GraphNode n in Nodes)
            {
                ...
                catch (Exception e)
                {
                    ...
                    CorticalAppHub.self.LogTime(e + "Node '" + n.ID + "' already exists!");
                }
            }
            sw.Stop();
            Debug.WriteLine("Time taken to set up nodes dictionary: " + sw.ElapsedMilliseconds + "ms");
            CorticalAppHub.self.LogTime("Time taken to set up nodes dictionary: " + sw.ElapsedMilliseconds + "ms");
        }
        ...
        */
        ...
        /*private void ComputeNodeAdjacencies()
        {
            ...
            CorticalAppHub.self.LogTime("Time taken to compute adjacencies: " + sw.ElapsedMilliseconds + "ms");
        }*/
