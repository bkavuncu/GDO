...
gdo.net.app["Leeds"].drawEmptyMapTable = function (maxCol, maxRow) {
...
gdo.net.app["Leeds"].numButtons =7;
...
gdo.net.app["Leeds"].drawMapTable = function (instanceId) {
    ...
    $("iframe").contents().find("#map_table_row_0_col_0")
        ...
        .unbind()
        .click(function () {
            gdo.net.app["Leeds"].server.setBingLayerVisible(instanceId);
        });
    ...
    $("iframe").contents().find("#map_table_row_0_col_6")
        ...
        .unbind()
        .click(function () {
            gdo.net.app["Leeds"].server.animate();
        });
