gdo.net.app["Twitter"].autoAllocateSections = function(instanceId){
    ...
    Object.keys(gdo.net.instance[instanceId].data.analytics).forEach(function (dataSetId, index) {
        ...
        analytic = gdo.net.instance[instanceId].data.analytics[dataSetId];
    ...
    gdo.consoleOut('.Twitter', 1, 'Total number of analytics options (Analytics:' + nAnalytics + ")(Graphs:" + nGraphs + ")");
    var counter = 0;
