...
var main_callback;
//var dd3Server = $.connection.dD3AppHub; //所有用到dd3Server变量的地方都注释掉了。
    ...
    var dd3 = (function () {
            ...
            */
            ...
            init.connectToSignalRServer = function () {
                ...
                dd3Net.net.client.on('connected',function(){
                    ...
                    dd3Net.net.client.on('joined',function(data){
        ...
        var defineDD3Functions = function () {
            ...
            dd3_data.receiveDimensions = function (dataId, dimensions) {
                ...
                utils.log(" dimensions  " + dimensions, 1);
