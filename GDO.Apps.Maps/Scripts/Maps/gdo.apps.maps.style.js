...
gdo.net.app["Maps"].uploadStyle = function (instanceId, styleId, isNew) {
    ...
    switch (type) {
        case gdo.net.app["Maps"].STYLE_TYPES_ENUM.Circle:
            gdo.net.app["Maps"].server.updateStyle(instanceId, styleId, properties.Name, properties.FillId, properties.Opacity, properties.RotateWithView,
                properties.Rotation, properties.Scale, properties.Radius, properties.SnapToPixel, properties.StrokeId);
            break;
        case gdo.net.app["Maps"].STYLE_TYPES_ENUM.Fill:
            gdo.net.app["Maps"].server.updateStyle(instanceId, styleId, properties.Name, properties.Color);
            break;
        case gdo.net.app["Maps"].STYLE_TYPES_ENUM.Icon:
            gdo.net.app["Maps"].server.updateStyle(instanceId, styleId, properties.Name, properties.CrossOrigin, properties.Anchor, properties.AnchorOrigin,
        ...
        case gdo.net.app["Maps"].STYLE_TYPES_ENUM.RegularShape:
            ...
            break;
        case gdo.net.app["Maps"].STYLE_TYPES_ENUM.Stroke:
            gdo.net.app["Maps"].server.updateStyle(instanceId, styleId, properties.Name, properties.Color, properties.LineCap, properties.LineJoin,
        ...
        case gdo.net.app["Maps"].STYLE_TYPES_ENUM.Style:
            ...
            break;
        case gdo.net.app["Maps"].STYLE_TYPES_ENUM.Text:
            gdo.net.app["Maps"].server.updateStyle(instanceId, styleId, properties.Name, properties.Font, properties.OffsetX, properties.OffsetY,
