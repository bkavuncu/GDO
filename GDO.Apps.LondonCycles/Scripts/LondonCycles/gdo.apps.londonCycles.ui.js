...
gdo.net.app["LondonCycles"].drawEmptyMapTable = function (maxCol, maxRow) {
...
gdo.net.app["LondonCycles"].numButtons =7;


gdo.net.app["LondonCycles"].drawMapTable = function (instanceId) {
    gdo.net.app["LondonCycles"].drawEmptyMapTable(7, 1);
    ...
    $("iframe").contents().find("#map_table_row_0_col_0")
        ...
        .unbind()
        .click(function () {
            gdo.net.app["LondonCycles"].server.setBingLayerVisible(instanceId);
        });
    ...
    $("iframe").contents().find("#map_table_row_0_col_2")
        ...
        .unbind()
        .click(function () {
            gdo.net.app["LondonCycles"].server.setOpenCycleLayerVisible(instanceId);
        });
    $("iframe").contents().find("#map_table_row_0_col_3")
        ...
        .unbind()
        .click(function () {
            gdo.net.app["LondonCycles"].server.setStationLayerVisible(instanceId);
        });
    $("iframe").contents().find("#map_table_row_0_col_4")
        ...
        .unbind()
        .click(function () {
            gdo.net.app["LondonCycles"].server.setHeatmapLayerVisible(instanceId);
        });
    $("iframe").contents().find("#map_table_row_0_col_5")
        ...
        .unbind()
        .click(function () {
            gdo.net.app["LondonCycles"].server.animate();
        });
