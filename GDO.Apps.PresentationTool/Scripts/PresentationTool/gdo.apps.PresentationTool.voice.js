    ...
    artyom.addCommands([
        {
            ...
            action: function (i) {
                ...
                gdo.net.app["PresentationTool"].server.requestVoiceInfo(gdo.controlId, "Hey there! You could say: Next, previous, play", 1);
        ...
        },
        {
            ...
            action: function (i) {
                ...
                gdo.net.app["PresentationTool"].server.requestVoiceInfo(gdo.controlId, "Playing next slide", 1);
                $("#next_slide").click();
            }
        },
        {
            ...
            action: function (i) {
                if (!voiceInitialized) return;
                artyom.say("Receive command");
                gdo.net.app["PresentationTool"].server.requestVoiceInfo(gdo.controlId, "Playing previous slide", 1);
...

        {
            ...
            action: function (i) {
                ...
                artyom.say("Receive command");
                if (curr_section !== 0) {
                    gdo.net.app["PresentationTool"].server.requestVoiceInfo(gdo.controlId, "Zoom in Image on Section " + (curr_section), 1);
