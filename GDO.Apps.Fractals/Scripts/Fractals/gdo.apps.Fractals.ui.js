gdo.net.app["Fractals"].initJoystick = function (id, receiveParams) {
...
gdo.net.app["Fractals"].initHeightSlider = function (id, receiveParams) {
...
gdo.net.app["Fractals"].initJoystick("#look_joystick", gdo.net.app["Fractals"].server.joystickReceiveParamsRot);
gdo.net.app["Fractals"].initJoystick("#move_joystick", gdo.net.app["Fractals"].server.joystickReceiveParamsMove);
gdo.net.app["Fractals"].initHeightSlider("#move_height_range", gdo.net.app["Fractals"].server.heightSliderReceiveParamsMove);

$("iframe").contents().find("#audio_start").on("click", function () {
    gdo.net.app["Fractals"].server.startAudio(gdo.controlId);
});

$("iframe").contents().find("#audio_stop").on("click", function () {
    gdo.net.app["Fractals"].server.stopAudio(gdo.controlId);
});
...
$("iframe").contents().find("#fractal_select").on("change", function () {
    ...
    var p = new gdo.net.app["Fractals"].params();
...
gdo.net.app["Fractals"].initJoystick("#light_joystick", gdo.net.app["Fractals"].server.joystickReceiveParamsLight);
gdo.net.app["Fractals"].initHeightSlider("#light_height_range", gdo.net.app["Fractals"].server.heightSliderReceiveParamsLight);
