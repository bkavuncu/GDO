...
$(function () {
    ...
    $.connection.sigmaGraphAppHub.client.renderNodes = function () {
        if (gdo.clientMode == gdo.CLIENT_MODE.NODE) {
    ...
    $.connection.sigmaGraphAppHub.client.renderBuffer = function (folderNameDigit) {
        if (gdo.clientMode == gdo.CLIENT_MODE.NODE) {

            gdo.consoleOut('.SIGMAGRAPHRENDERER', 1, 'Instance - ' + gdo.clientId + ": Rendering graph buffer");
    ...
    $.connection.sigmaGraphAppHub.client.renderGraph = function (folderNameDigit, zoomed) {
        if (gdo.clientMode == gdo.CLIENT_MODE.NODE) {
            ...
            gdo.consoleOut('.SIGMAGRAPHRENDERER', 1, 'Instance - ' + gdo.clientId + ": Downloading Graph : " + "AppInstance_" + gdo.net.node[gdo.clientId].appInstanceId + "Partition_" + gdo.net.node[gdo.clientId].sectionRow + "_" + gdo.net.node[gdo.clientId].sectionCol);
