gdo.net.app["RayMarching"].initJoystick = function (id, receiveParams) {
...
gdo.net.app["RayMarching"].initHeightSlider = function (id, receiveParams) {
...
gdo.net.app["RayMarching"].initJoystick("#look_joystick", gdo.net.app["RayMarching"].server.joystickReceiveParamsRot);
gdo.net.app["RayMarching"].initJoystick("#move_joystick", gdo.net.app["RayMarching"].server.joystickReceiveParamsMove);
gdo.net.app["RayMarching"].initHeightSlider("#move_height_range", gdo.net.app["RayMarching"].server.heightSliderReceiveParamsMove);
